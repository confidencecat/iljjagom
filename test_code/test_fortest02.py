...
def enhance_contrast_for_ocr_simple(image_path, output_dir="./fortest02"):
    """
...
def test_fortest02():
    """
    fortest02 이미지에 대한 간소화된 OCR 테스트
    """
    # fortest02.jpg 파일 찾기
    possible_paths = [
        "fortest02.jpg",
    ...
    if image_path is None:
        print("fortest02.jpg 파일을 찾을 수 없습니다.")
        print("현재 디렉토리:", os.getcwd())
        return
    
    print(f"=== fortest02 대조 향상 OCR 테스트: {image_path} ===")
    ...
    # 결과를 텍스트 파일로 저장
    result_file = "./fortest02/fortest02_ocr_results.txt"
    with open(result_file, 'w', encoding='utf-8') as f:
        f.write("fortest02 OCR 성능 비교 결과\n")
        f.write("="*80 + "\n\n")
